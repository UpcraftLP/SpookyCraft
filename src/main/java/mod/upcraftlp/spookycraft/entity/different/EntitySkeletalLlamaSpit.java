...
public class EntitySkeletalLlamaSpit extends Entity implements IProjectile
{
    public EntitySkeletalLlama owner;
    private NBTTagCompound ownerNbt;

    public EntitySkeletalLlamaSpit(World worldIn)
    {
        super(worldIn);
    }

	public EntitySkeletalLlamaSpit(World worldIn, EntitySkeletalLlama p_i47273_2_)
    {
        super(worldIn);
    ...
    public EntitySkeletalLlamaSpit(World worldIn, double x, double y, double z, double p_i47274_8_, double p_i47274_10_, double p_i47274_12_)
    {
        super(worldIn);
    ...
    private void restoreOwnerFromSave()
    {
        if (this.ownerNbt != null && this.ownerNbt.hasUniqueId("OwnerUUID"))
        {
            ...
            for (EntitySkeletalLlama entityllama : this.world.getEntitiesWithinAABB(EntitySkeletalLlama.class, this.getEntityBoundingBox().grow(15.0D)))
            {

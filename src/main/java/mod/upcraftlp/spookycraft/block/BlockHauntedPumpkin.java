...
public class BlockHauntedPumpkin extends Block {
    ...
    {
        if (ScaryNightHandler.isNightTime(worldIn) && rand.nextDouble() < 0.3D)
        {
            ...
            {
                worldIn.playSound((double)pos.getX() + 0.5D, (double)pos.getY(), (double)pos.getZ() + 0.5D, SoundEvents.BLOCK_FURNACE_FIRE_CRACKLE, SoundCategory.BLOCKS, rand.nextFloat() * 0.6F, rand.nextFloat(), false);
            }

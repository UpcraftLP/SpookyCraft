...
public class ModelSkeletalRabbit extends ModelBase {
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
		...
		EntitySkeletalRabbit entityrabbit = (EntitySkeletalRabbit) entityIn;
	...
	public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount,
		...
		this.jumpRotation = MathHelper
				.sin(((EntitySkeletalRabbit) entitylivingbaseIn).setJumpCompletion(partialTickTime) * (float) Math.PI);
	}
}

...
public class RenderSkeletalLlamaSpit extends Render<EntitySkeletalLlamaSpit> {
	private static final ResourceLocation LLAMA_SPIT_TEXTURE = new ResourceLocation(Reference.MODID,
			"textures/entity/skeletal_spit.png");
	private final ModelLlamaSpit model = new ModelLlamaSpit();

	public RenderSkeletalLlamaSpit(RenderManager p_i47202_1_) {
		super(p_i47202_1_);
	}
	 ...
	 */
	public void doRender(EntitySkeletalLlamaSpit entity, double x, double y, double z, float entityYaw,
			float partialTicks) {
	 ...
	 */
	protected ResourceLocation getEntityTexture(EntitySkeletalLlamaSpit entity) {

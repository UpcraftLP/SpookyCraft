...
public class SpookyEntities {
	...
	public static void init() {
		EntityRegistry.registerModEntity(getEntityResource("ScareCrow"), EntityScareCrow.class, "ScareCrow", 0,
				Main.INSTANCE, 80, 3, false, eggPrimary, eggSecondary);
		// FIXME re-enable once finished!
		// EntityRegistry.registerModEntity(getEntityResource("Mirror"),
		// EntityMirror.class, "Mirror", 1, Main.INSTANCE, 80, 3, false,
		// eggPrimary, egg);
		...
		EntityRegistry.registerModEntity(getEntityResource("SkeletalChicken"), EntitySkeletalChicken.class,
				"SkeletalChicken", 3, Main.INSTANCE, 80, 3, false, eggPrimary, eggSecondary);
		...
		EntityRegistry.registerModEntity(getEntityResource("SkeletalParrot"), EntitySkeletalParrot.class,
				"SkeletalParrot", 5, Main.INSTANCE, 80, 3, false, eggPrimary, eggSecondary);
